...
const documents: Documents = {
    ...
    "\n  mutation RegisterTimetableEntry($courseID: ID!) {\n    registerTimetableEntry(courseID: $courseID) {\n      ID\n      isProfileVisible\n      createdAt\n      course {\n        ID\n        roomID\n        dayOfWeek\n        period\n        teacherName\n        courseName\n        year\n        semester\n        createdAt\n      }\n    }\n  }\n": types.RegisterTimetableEntryDocument,
    "\n  mutation RemoveTimetableEntry($id: ID!) {\n    removeTimetableEntry(id: $id)\n  }\n": types.RemoveTimetableEntryDocument,
