...
const documents: Documents = {
    ...
    "\n  mutation AdminUpdateCommunityMembers($communityID: ID!, $updates: [CommunityMemberUpdateInput!]!) {\n    updateCommunityMembers(communityID: $communityID, updates: $updates)\n  }\n": types.AdminUpdateCommunityMembersDocument,
    "\n  query AdminCommunityMembers($communityID: ID!, $limit: Int!, $offset: Int!) {\n    communityMembers(communityID: $communityID, limit: $limit, offset: $offset) {\n      items {\n        user {\n          ID\n          accountID\n          name\n        }\n        role\n      }\n      total\n    }\n  }\n": types.AdminCommunityMembersDocument,
    "\n  query AdminListMessages($roomID: ID!, $limit: Int, $before: ID) {\n    messages(roomID: $roomID, limit: $limit, before: $before) {\n      items {\n        ID\n        roomID\n        user {\n          ID\n          name\n          accountID\n          avatarUrl\n        }\n        content\n        media {\n          ...MediaFields\n        }\n        createdAt\n        updatedAt\n      }\n      hasMoreBefore\n    }\n  }\n": types.AdminListMessagesDocument,
    "\n  mutation DeleteMessage($roomID: ID!, $id: ID!) {\n    deleteMessage(roomID: $roomID, id: $id)\n  }\n": types.DeleteMessageDocument,
    "\n  query AdminCurrentSemester {\n    currentSemester {\n      year\n      semester\n    }\n  }\n": types.AdminCurrentSemesterDocument,
    "\n  mutation AdminUpdateCurrentSemester($year: Int!, $semester: String!) {\n    updateCurrentSemester(year: $year, semester: $semester) {\n      year\n      semester\n    }\n  }\n": types.AdminUpdateCurrentSemesterDocument,
    "\n  query AdminCourseImportStatus {\n    adminCourseImportStatus {\n      state\n      year\n      imported\n      skipped\n      errorMessage\n      startedAt\n      finishedAt\n      processedCount\n      totalCount\n      progressPercent\n    }\n  }\n": types.AdminCourseImportStatusDocument,
    "\n  mutation AdminTriggerCourseImport($year: Int!) {\n    adminTriggerCourseImport(year: $year) {\n      state\n      year\n      imported\n      skipped\n      errorMessage\n      startedAt\n      finishedAt\n      processedCount\n      totalCount\n      progressPercent\n    }\n  }\n": types.AdminTriggerCourseImportDocument,
    "\n  query AdminListCourses($year: Int, $semester: String, $dayOfWeek: String, $keyword: String, $limit: Int, $offset: Int) {\n    adminListCourses(year: $year, semester: $semester, dayOfWeek: $dayOfWeek, keyword: $keyword, limit: $limit, offset: $offset) {\n      items {\n        ID\n        roomID\n        dayOfWeek\n        period\n        teacherName\n        courseName\n        year\n        semester\n        createdAt\n        registeredCount\n      }\n      total\n    }\n  }\n": types.AdminListCoursesDocument,
    "\n  mutation AdminCreateCourse($input: AdminCreateCourseInput!) {\n    adminCreateCourse(input: $input) {\n      ID\n      roomID\n      dayOfWeek\n      period\n      teacherName\n      courseName\n      year\n      semester\n      createdAt\n      registeredCount\n    }\n  }\n": types.AdminCreateCourseDocument,
    "\n  mutation AdminDeleteCourse($id: ID!) {\n    adminDeleteCourse(id: $id)\n  }\n": types.AdminDeleteCourseDocument,
    "\n  query AdminListCourseYears {\n    adminListCourseYears\n  }\n": types.AdminListCourseYearsDocument,
    "\n  query AdminGetCourse($id: ID!) {\n    adminGetCourse(id: $id) {\n      ID\n      roomID\n      dayOfWeek\n      period\n      teacherName\n      courseName\n      year\n      semester\n      createdAt\n    }\n  }\n": types.AdminGetCourseDocument,
    "\n  query AdminGetCourseQuestions($roomID: ID!, $limit: Int, $offset: Int) {\n    questions(roomID: $roomID, limit: $limit, offset: $offset) {\n      items {\n        ID\n        roomID\n        user {\n          ID\n          name\n          accountID\n          avatarUrl\n        }\n        body\n        isAnswered\n        # 一覧に出しているのは回答の件数だけ。以前は answers(limit: 200) で\n        # 回答の本文と投稿者を全部取り、その length を件数にしていた。\n        # 質問200件 × 回答200件で、最大4万行が1回の応答に乗っていた。\n        answerCount\n        createdAt\n      }\n      total\n    }\n  }\n": types.AdminGetCourseQuestionsDocument,
    "\n  mutation AdminDeleteQuestion($id: ID!) {\n    adminDeleteQuestion(id: $id)\n  }\n": types.AdminDeleteQuestionDocument,
    "\n  query AdminGetCoursePolls($roomID: ID!, $limit: Int, $offset: Int) {\n    polls(roomID: $roomID, limit: $limit, offset: $offset) {\n      items {\n        ID\n        roomID\n        user {\n          ID\n          name\n          accountID\n          avatarUrl\n        }\n        question\n        allowMultipleChoice\n        options {\n          ID\n          label\n          voteCount\n        }\n        createdAt\n      }\n      total\n    }\n  }\n": types.AdminGetCoursePollsDocument,
    "\n  mutation AdminDeletePoll($pollID: ID!) {\n    deletePoll(pollID: $pollID)\n  }\n": types.AdminDeletePollDocument,
    ...
    "\n  query GetAdminPostReplies($id: ID!, $limit: Int!, $offset: Int!) {\n    getPostByIDIncludeDeleted(id: $id) {\n      replies(limit: $limit, offset: $offset) {\n        ...AdminPostFields\n      }\n    }\n  }\n": types.GetAdminPostRepliesDocument,
    ...
    "\n  query CommunityMembers($communityID: ID!, $limit: Int!, $offset: Int!) {\n    communityMembers(communityID: $communityID, limit: $limit, offset: $offset) {\n      items {\n        user {\n          ID\n          accountID\n          name\n          avatarUrl\n        }\n        role\n      }\n      total\n    }\n  }\n": types.CommunityMembersDocument,
    ...
    "\n  query SearchCourses($dayOfWeek: String!, $period: Int!, $keyword: String, $limit: Int, $offset: Int) {\n    searchCourses(dayOfWeek: $dayOfWeek, period: $period, keyword: $keyword, limit: $limit, offset: $offset) {\n      items {\n        ID\n        roomID\n        dayOfWeek\n        period\n        teacherName\n        courseName\n        year\n        semester\n        createdAt\n      }\n      total\n    }\n  }\n": types.SearchCoursesDocument,
    "\n  query MyTimetable($year: Int, $semester: String) {\n    myTimetable(year: $year, semester: $semester) {\n      ID\n      color\n      createdAt\n      course {\n        ID\n        roomID\n        dayOfWeek\n        period\n        teacherName\n        courseName\n        year\n        semester\n        createdAt\n      }\n    }\n  }\n": types.MyTimetableDocument,
    ...
    "\n  query MentionCandidates($roomID: ID!, $prefix: String!, $limit: Int!) {\n    mentionCandidates(roomID: $roomID, prefix: $prefix, limit: $limit) {\n      ID\n      name\n      accountID\n      avatarUrl\n    }\n  }\n": types.MentionCandidatesDocument,
    ...
    "\n  mutation IssueNotificationStreamTicket {\n    issueNotificationStreamTicket\n  }\n": types.IssueNotificationStreamTicketDocument,
    ...
    "\n  mutation AnswerQuestion($questionID: ID!, $body: String!, $mediaInputs: [MediaUploadInput!]) {\n    answerQuestion(questionID: $questionID, body: $body, mediaInputs: $mediaInputs) {\n      ID\n      questionID\n      user {\n        ID\n        name\n        accountID\n        avatarUrl\n      }\n      body\n      media {\n        ...MediaFields\n      }\n      createdAt\n      isMine\n      likeCount\n      likedByMe\n    }\n  }\n": types.AnswerQuestionDocument,
    "\n  mutation SelectBestAnswer($questionID: ID!, $answerID: ID!) {\n    selectBestAnswer(questionID: $questionID, answerID: $answerID) {\n      ID\n      isAnswered\n      bestAnswer {\n        ID\n        body\n      }\n      updatedAt\n    }\n  }\n": types.SelectBestAnswerDocument,
    "\n  mutation CancelBestAnswer($questionID: ID!) {\n    cancelBestAnswer(questionID: $questionID) {\n      ID\n      isAnswered\n      bestAnswer {\n        ID\n        body\n      }\n      updatedAt\n    }\n  }\n": types.CancelBestAnswerDocument,
    "\n  mutation UpdateAnswer($id: ID!, $body: String!, $deletedMediaIDs: [ID!]) {\n    updateAnswer(id: $id, body: $body, deletedMediaIDs: $deletedMediaIDs) {\n      ID\n      body\n      media {\n        ...MediaFields\n      }\n    }\n  }\n": types.UpdateAnswerDocument,
    "\n  mutation DeleteAnswer($id: ID!) {\n    deleteAnswer(id: $id)\n  }\n": types.DeleteAnswerDocument,
    "\n  mutation LikeAnswer($id: ID!) {\n    likeAnswer(id: $id) {\n      ID\n      likeCount\n      likedByMe\n    }\n  }\n": types.LikeAnswerDocument,
    "\n  mutation UnlikeAnswer($id: ID!) {\n    unlikeAnswer(id: $id) {\n      ID\n      likeCount\n      likedByMe\n    }\n  }\n": types.UnlikeAnswerDocument,
