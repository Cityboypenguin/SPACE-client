...
export type AdminCourseImportStatusQuery = { adminCourseImportStatus: { state: CourseImportState, year: number | null, imported: number | null, skipped: number | null, errorMessage: string | null, startedAt: string | null, finishedAt: string | null } };
...
export type AdminTriggerCourseImportMutation = { adminTriggerCourseImport: { state: CourseImportState, year: number | null, imported: number | null, skipped: number | null, errorMessage: string | null, startedAt: string | null, finishedAt: string | null } };
