...
export type PollsQuery = { polls: { total: number, items: Array<{ ID: string, roomID: string, question: string, allowMultipleChoice: boolean, createdAt: string, isMine: boolean, user: { ID: string, name: string, accountID: string, avatarUrl: string | null }, options: Array<{ ID: string, label: string, voteCount: number, votedByMe: boolean }> }> } };
...
export type CreatePollMutation = { createPoll: { ID: string, roomID: string, question: string, allowMultipleChoice: boolean, createdAt: string, isMine: boolean, user: { ID: string, name: string, accountID: string, avatarUrl: string | null }, options: Array<{ ID: string, label: string, voteCount: number, votedByMe: boolean }> } };
