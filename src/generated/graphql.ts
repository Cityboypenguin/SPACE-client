...
export type AdminGetCourseQuestionsQuery = { questions: { total: number, items: Array<{ ID: string, roomID: string, body: string, isAnswered: boolean, createdAt: string, user: { ID: string, name: string, accountID: string, avatarUrl: string | null }, answers: { items: Array<{ ID: string, questionID: string, body: string, createdAt: string, user: { ID: string, name: string, accountID: string, avatarUrl: string | null } }> } }> } };
...
export type GetCommunityMembersQuery = { getCommunityMembers: Array<{ role: string, user: { ID: string, accountID: string, name: string, avatarUrl: string | null } }> };
...
export type PostFieldsFragment = { ID: string, content: string, createdAt: string, replyCount: number, deletedAt: string | null, user: { ID: string, name: string, accountID: string, avatarUrl: string | null }, favorites: Array<{ ID: string, user: { ID: string } }>, media: Array<{ ID: string, url: string, contentType: string, width: number | null, height: number | null }>, mentions: Array<{ text: string, user: { ID: string, name: string, accountID: string, avatarUrl: string | null } }> };
...
export type UpdateMyProfileMutation = { updateMyProfile: { username: string, bio: string | null, avatarUrl: string | null, createdAt: string, updatedAt: string, user: { ID: string, accountID: string, name: string, email: string, role: string, status: string, avatarUrl: string | null, createdAt: string, updatedAt: string } } };
