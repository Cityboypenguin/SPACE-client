...
export type AdminGetTimeSeriesQuery = { adminGetTimeSeries: { points: Array<{ label: string, posts: number, comments: number, messages: number, newUsers: number, likes: number }> } };
