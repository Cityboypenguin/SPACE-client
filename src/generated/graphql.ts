...
export type SendMessageMutation = { sendMessage: { ID: string, roomID: string, content: string, createdAt: string, updatedAt: string, isMine: boolean, user: { ID: string, name: string, accountID: string, avatarUrl: string | null }, media: Array<{ ID: string, url: string, contentType: string, width: number | null, height: number | null }> } };
...
export type UpdateMessageMutation = { updateMessage: { ID: string, roomID: string, content: string, createdAt: string, updatedAt: string, isMine: boolean, user: { ID: string, name: string, accountID: string, avatarUrl: string | null }, media: Array<{ ID: string, url: string, contentType: string, width: number | null, height: number | null }> } };
...
export type ListMessagesQuery = { messages: { hasMoreBefore: boolean, hasMoreAfter: boolean, items: Array<{ ID: string, roomID: string, content: string, createdAt: string, updatedAt: string, isMine: boolean, user: { ID: string, name: string, accountID: string, avatarUrl: string | null }, media: Array<{ ID: string, url: string, contentType: string, width: number | null, height: number | null }> }> } };
