...
export type PollsQuery = { polls: { total: number, unvotedTotal: number, items: Array<{ ID: string, roomID: string, question: string, allowMultipleChoice: boolean, deadline: string | null, createdAt: string, isMine: boolean, user: { ID: string, name: string, accountID: string, avatarUrl: string | null, role: string }, options: Array<{ ID: string, label: string, voteCount: number, votedByMe: boolean }> }> } };
...
export type CreatePollMutation = { createPoll: { ID: string, roomID: string, question: string, allowMultipleChoice: boolean, deadline: string | null, createdAt: string, isMine: boolean, user: { ID: string, name: string, accountID: string, avatarUrl: string | null, role: string }, options: Array<{ ID: string, label: string, voteCount: number, votedByMe: boolean }> } };
...
export type VotePollMutation = { votePoll: { ID: string, options: Array<{ ID: string, label: string, voteCount: number, votedByMe: boolean }> } };
...
export type UpdateAnswerMutation = { updateAnswer: { ID: string, body: string } };
...
export const UpdateAnswerDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateAnswer"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"body"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateAnswer"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"body"},"value":{"kind":"Variable","name":{"kind":"Name","value":"body"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"ID"}},{"kind":"Field","name":{"kind":"Name","value":"body"}}]}}]}}]} as unknown as DocumentNode<UpdateAnswerMutation, UpdateAnswerMutationVariables>;
