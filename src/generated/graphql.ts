...
export type SelectBestAnswerMutation = { selectBestAnswer: { ID: string, isAnswered: boolean, updatedAt: string, bestAnswer: { ID: string } | null } };
...
export type CancelBestAnswerMutation = { cancelBestAnswer: { ID: string, isAnswered: boolean, updatedAt: string, bestAnswer: { ID: string } | null } };
