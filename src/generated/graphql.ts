...
export type AdminListCoursesQuery = { adminListCourses: { total: number, items: Array<{ ID: string, roomID: string, dayOfWeek: string, period: number, teacherName: string, courseName: string, year: number, semester: string, createdAt: string }> } };
